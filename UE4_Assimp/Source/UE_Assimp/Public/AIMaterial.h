...
public:
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "Assimp|Material")
	FString GetTexturePath(EAiTextureType TextureType) const;

	UFUNCTION(BlueprintCallable, Category = "Assimp|Material")
	bool HasTexture(EAiTextureType TextureType) const;
