...
UE_ASSIMP_API UEnum* Z_Construct_UEnum_UE_Assimp_EAIMeshBuildState();
UE_ASSIMP_API UScriptStruct* Z_Construct_UScriptStruct_FAIBone();
UPackage* Z_Construct_UPackage__Script_UE_Assimp();
// End Cross Module References

// Begin Enum EAIMeshBuildState
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EAIMeshBuildState;
static UEnum* EAIMeshBuildState_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EAIMeshBuildState.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EAIMeshBuildState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_UE_Assimp_EAIMeshBuildState, (UObject*)Z_Construct_UPackage__Script_UE_Assimp(), TEXT("EAIMeshBuildState"));
	}
	return Z_Registration_Info_UEnum_EAIMeshBuildState.OuterSingleton;
}
template<> UE_ASSIMP_API UEnum* StaticEnum<EAIMeshBuildState>()
{
	return EAIMeshBuildState_StaticEnum();
}
struct Z_Construct_UEnum_UE_Assimp_EAIMeshBuildState_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "BuildTriangles.Name", "EAIMeshBuildState::BuildTriangles" },
		{ "BuildVertices.Name", "EAIMeshBuildState::BuildVertices" },
		{ "Enqueued.Name", "EAIMeshBuildState::Enqueued" },
		{ "Finalize_Collision.Name", "EAIMeshBuildState::Finalize_Collision" },
		{ "Finalize_Init.Name", "EAIMeshBuildState::Finalize_Init" },
		{ "Finalize_Prepare.Name", "EAIMeshBuildState::Finalize_Prepare" },
		{ "ModuleRelativePath", "Public/AIMesh.h" },
		{ "None.Name", "EAIMeshBuildState::None" },
		{ "RawReady.Name", "EAIMeshBuildState::RawReady" },
		{ "Ready.Name", "EAIMeshBuildState::Ready" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EAIMeshBuildState::None", (int64)EAIMeshBuildState::None },
		{ "EAIMeshBuildState::Enqueued", (int64)EAIMeshBuildState::Enqueued },
		{ "EAIMeshBuildState::RawReady", (int64)EAIMeshBuildState::RawReady },
		{ "EAIMeshBuildState::BuildVertices", (int64)EAIMeshBuildState::BuildVertices },
		{ "EAIMeshBuildState::BuildTriangles", (int64)EAIMeshBuildState::BuildTriangles },
		{ "EAIMeshBuildState::Finalize_Prepare", (int64)EAIMeshBuildState::Finalize_Prepare },
		{ "EAIMeshBuildState::Finalize_Init", (int64)EAIMeshBuildState::Finalize_Init },
		{ "EAIMeshBuildState::Finalize_Collision", (int64)EAIMeshBuildState::Finalize_Collision },
		{ "EAIMeshBuildState::Ready", (int64)EAIMeshBuildState::Ready },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_UE_Assimp_EAIMeshBuildState_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_UE_Assimp,
	nullptr,
	"EAIMeshBuildState",
	"EAIMeshBuildState",
	Z_Construct_UEnum_UE_Assimp_EAIMeshBuildState_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_UE_Assimp_EAIMeshBuildState_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_UE_Assimp_EAIMeshBuildState_Statics::Enum_MetaDataParams), Z_Construct_UEnum_UE_Assimp_EAIMeshBuildState_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_UE_Assimp_EAIMeshBuildState()
{
	if (!Z_Registration_Info_UEnum_EAIMeshBuildState.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EAIMeshBuildState.InnerSingleton, Z_Construct_UEnum_UE_Assimp_EAIMeshBuildState_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EAIMeshBuildState.InnerSingleton;
}
// End Enum EAIMeshBuildState
...
// Begin Class UAIMesh Function InvalidateCache
struct Z_Construct_UFunction_UAIMesh_InvalidateCache_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Assimp|AIMesh" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAIMesh_InvalidateCache_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAIMesh, nullptr, "InvalidateCache", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAIMesh_InvalidateCache_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAIMesh_InvalidateCache_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_UAIMesh_InvalidateCache()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UAIMesh_InvalidateCache_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UAIMesh::execInvalidateCache)
{
	P_FINISH;
	P_NATIVE_BEGIN;
...
// End Class UAIMesh Function InvalidateCache
...
void UAIMesh::StaticRegisterNativesUAIMesh()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "InvalidateCache", &UAIMesh::execInvalidateCache },
	};
...
struct Z_Construct_UClass_UAIMesh_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UAIMesh_InvalidateCache, "InvalidateCache" }, // 3138768038
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AIMesh_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EAIMeshBuildState_StaticEnum, TEXT("EAIMeshBuildState"), &Z_Registration_Info_UEnum_EAIMeshBuildState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 753224795U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAIMesh, UAIMesh::StaticClass, TEXT("UAIMesh"), &Z_Registration_Info_UClass_UAIMesh, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAIMesh), 2415325054U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AIMesh_h_3798953370(TEXT("/Script/UE_Assimp"),
	Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AIMesh_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AIMesh_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AIMesh_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AIMesh_h_Statics::EnumInfo));
// End Registration
