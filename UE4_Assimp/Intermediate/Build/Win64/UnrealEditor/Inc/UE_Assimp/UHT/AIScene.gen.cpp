...
UE_ASSIMP_API UEnum* Z_Construct_UEnum_UE_Assimp_EAISceneBuildPhase();
UPackage* Z_Construct_UPackage__Script_UE_Assimp();
// End Cross Module References

// Begin Enum EAISceneBuildPhase
static FEnumRegistrationInfo Z_Registration_Info_UEnum_EAISceneBuildPhase;
static UEnum* EAISceneBuildPhase_StaticEnum()
{
	if (!Z_Registration_Info_UEnum_EAISceneBuildPhase.OuterSingleton)
	{
		Z_Registration_Info_UEnum_EAISceneBuildPhase.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_UE_Assimp_EAISceneBuildPhase, (UObject*)Z_Construct_UPackage__Script_UE_Assimp(), TEXT("EAISceneBuildPhase"));
	}
	return Z_Registration_Info_UEnum_EAISceneBuildPhase.OuterSingleton;
}
template<> UE_ASSIMP_API UEnum* StaticEnum<EAISceneBuildPhase>()
{
	return EAISceneBuildPhase_StaticEnum();
}
struct Z_Construct_UEnum_UE_Assimp_EAISceneBuildPhase_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "Cameras.Name", "EAISceneBuildPhase::Cameras" },
		{ "Finished.Name", "EAISceneBuildPhase::Finished" },
		{ "Lights.Name", "EAISceneBuildPhase::Lights" },
		{ "Materials.Name", "EAISceneBuildPhase::Materials" },
		{ "Meshes.Name", "EAISceneBuildPhase::Meshes" },
		{ "ModuleRelativePath", "Public/AIScene.h" },
		{ "Nodes.Name", "EAISceneBuildPhase::Nodes" },
		{ "None.Name", "EAISceneBuildPhase::None" },
	};
#endif // WITH_METADATA
	static constexpr UECodeGen_Private::FEnumeratorParam Enumerators[] = {
		{ "EAISceneBuildPhase::None", (int64)EAISceneBuildPhase::None },
		{ "EAISceneBuildPhase::Meshes", (int64)EAISceneBuildPhase::Meshes },
		{ "EAISceneBuildPhase::Cameras", (int64)EAISceneBuildPhase::Cameras },
		{ "EAISceneBuildPhase::Lights", (int64)EAISceneBuildPhase::Lights },
		{ "EAISceneBuildPhase::Materials", (int64)EAISceneBuildPhase::Materials },
		{ "EAISceneBuildPhase::Nodes", (int64)EAISceneBuildPhase::Nodes },
		{ "EAISceneBuildPhase::Finished", (int64)EAISceneBuildPhase::Finished },
	};
	static const UECodeGen_Private::FEnumParams EnumParams;
};
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_UE_Assimp_EAISceneBuildPhase_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_UE_Assimp,
	nullptr,
	"EAISceneBuildPhase",
	"EAISceneBuildPhase",
	Z_Construct_UEnum_UE_Assimp_EAISceneBuildPhase_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_UE_Assimp_EAISceneBuildPhase_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_UE_Assimp_EAISceneBuildPhase_Statics::Enum_MetaDataParams), Z_Construct_UEnum_UE_Assimp_EAISceneBuildPhase_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_UE_Assimp_EAISceneBuildPhase()
{
	if (!Z_Registration_Info_UEnum_EAISceneBuildPhase.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EAISceneBuildPhase.InnerSingleton, Z_Construct_UEnum_UE_Assimp_EAISceneBuildPhase_Statics::EnumParams);
	}
	return Z_Registration_Info_UEnum_EAISceneBuildPhase.InnerSingleton;
}
// End Enum EAISceneBuildPhase
...
struct Z_Construct_UClass_UAIScene_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BuildPhase_MetaData[] = {
		{ "ModuleRelativePath", "Public/AIScene.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BuildIndex_MetaData[] = {
		{ "ModuleRelativePath", "Public/AIScene.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BuildBatchSize_MetaData[] = {
		{ "Category", "AIScene" },
		{ "ModuleRelativePath", "Public/AIScene.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MaxBuildTimeMsPerTick_MetaData[] = {
		{ "Category", "Assimp Build" },
		{ "ClampMin", "0.1" },
		{ "ModuleRelativePath", "Public/AIScene.h" },
		{ "UIMax", "8.0" },
	...
	static const UECodeGen_Private::FBytePropertyParams NewProp_BuildPhase_Underlying;
	static const UECodeGen_Private::FEnumPropertyParams NewProp_BuildPhase;
	static const UECodeGen_Private::FUInt32PropertyParams NewProp_BuildIndex;
	static const UECodeGen_Private::FIntPropertyParams NewProp_BuildBatchSize;
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_MaxBuildTimeMsPerTick;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_OwnedMeshes = { "OwnedMeshes", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, OwnedMeshes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OwnedMeshes_MetaData), NewProp_OwnedMeshes_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_OwnedRootNode = { "OwnedRootNode", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, OwnedRootNode), Z_Construct_UClass_UAINode_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OwnedRootNode_MetaData), NewProp_OwnedRootNode_MetaData) };
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_OwnedCameras = { "OwnedCameras", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, OwnedCameras), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OwnedCameras_MetaData), NewProp_OwnedCameras_MetaData) };
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_OwnedLights = { "OwnedLights", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, OwnedLights), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OwnedLights_MetaData), NewProp_OwnedLights_MetaData) };
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_OwnedMaterials = { "OwnedMaterials", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, OwnedMaterials), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OwnedMaterials_MetaData), NewProp_OwnedMaterials_MetaData) };
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_BuildPhase_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, nullptr, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_BuildPhase = { "BuildPhase", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, BuildPhase), Z_Construct_UEnum_UE_Assimp_EAISceneBuildPhase, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BuildPhase_MetaData), NewProp_BuildPhase_MetaData) }; // 564526764
const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_BuildIndex = { "BuildIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, BuildIndex), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BuildIndex_MetaData), NewProp_BuildIndex_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_BuildBatchSize = { "BuildBatchSize", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, BuildBatchSize), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BuildBatchSize_MetaData), NewProp_BuildBatchSize_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_MaxMeshesPerFrame = { "MaxMeshesPerFrame", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, MaxMeshesPerFrame), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaxMeshesPerFrame_MetaData), NewProp_MaxMeshesPerFrame_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_MaxCamerasPerFrame = { "MaxCamerasPerFrame", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, MaxCamerasPerFrame), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaxCamerasPerFrame_MetaData), NewProp_MaxCamerasPerFrame_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_MaxLightsPerFrame = { "MaxLightsPerFrame", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, MaxLightsPerFrame), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaxLightsPerFrame_MetaData), NewProp_MaxLightsPerFrame_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_MaxMaterialsPerFrame = { "MaxMaterialsPerFrame", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, MaxMaterialsPerFrame), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaxMaterialsPerFrame_MetaData), NewProp_MaxMaterialsPerFrame_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_MaxNodesPerFrame = { "MaxNodesPerFrame", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, MaxNodesPerFrame), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaxNodesPerFrame_MetaData), NewProp_MaxNodesPerFrame_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_LoopBuildHandleTime = { "LoopBuildHandleTime", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, LoopBuildHandleTime), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_LoopBuildHandleTime_MetaData), NewProp_LoopBuildHandleTime_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAIScene_Statics::NewProp_MaxBuildTimeMsPerTick = { "MaxBuildTimeMsPerTick", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAIScene, MaxBuildTimeMsPerTick), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaxBuildTimeMsPerTick_MetaData), NewProp_MaxBuildTimeMsPerTick_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAIScene_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAIScene_Statics::NewProp_BuildPhase_Underlying,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAIScene_Statics::NewProp_BuildPhase,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAIScene_Statics::NewProp_BuildIndex,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAIScene_Statics::NewProp_BuildBatchSize,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAIScene_Statics::NewProp_MaxMeshesPerFrame,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAIScene_Statics::NewProp_MaxCamerasPerFrame,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAIScene_Statics::NewProp_MaxLightsPerFrame,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAIScene_Statics::NewProp_MaxMaterialsPerFrame,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAIScene_Statics::NewProp_MaxNodesPerFrame,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAIScene_Statics::NewProp_LoopBuildHandleTime,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAIScene_Statics::NewProp_MaxBuildTimeMsPerTick,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AIScene_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EAISceneBuildPhase_StaticEnum, TEXT("EAISceneBuildPhase"), &Z_Registration_Info_UEnum_EAISceneBuildPhase, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 564526764U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAIScene, UAIScene::StaticClass, TEXT("UAIScene"), &Z_Registration_Info_UClass_UAIScene, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAIScene), 2177779800U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AIScene_h_2080159535(TEXT("/Script/UE_Assimp"),
	Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AIScene_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AIScene_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AIScene_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AIScene_h_Statics::EnumInfo));
// End Registration
