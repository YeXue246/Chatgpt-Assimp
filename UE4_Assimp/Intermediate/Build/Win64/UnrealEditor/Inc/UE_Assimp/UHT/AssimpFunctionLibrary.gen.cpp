...
UE_ASSIMP_API UClass* Z_Construct_UClass_UAssimpImportContext();
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_UE_Assimp_OnProgressUpdated__DelegateSignature_Statics::NewProp_Progress = { "Progress", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_UE_Assimp_eventOnProgressUpdated_Parms, Progress), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_UE_Assimp_OnProgressUpdated__DelegateSignature_Statics::NewProp_Scene = { "Scene", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_UE_Assimp_eventOnProgressUpdated_Parms, Scene), Z_Construct_UClass_UAIScene_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Scene_MetaData), NewProp_Scene_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_UE_Assimp_OnProgressUpdated__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_UE_Assimp_OnProgressUpdated__DelegateSignature_Statics::NewProp_Progress,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_UE_Assimp_OnProgressUpdated__DelegateSignature_Statics::NewProp_Scene,
};
...
void FOnProgressUpdated_DelegateWrapper(const FScriptDelegate& OnProgressUpdated, float Progress, UAIScene* Scene)
{
	struct _Script_UE_Assimp_eventOnProgressUpdated_Parms
	{
		float Progress;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_UE_Assimp_OnImportSceneComplete__DelegateSignature_Statics::NewProp_Scenes_Inner = { "Scenes", nullptr, (EPropertyFlags)0x0000000000080000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UAIScene_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_UE_Assimp_OnImportSceneComplete__DelegateSignature_Statics::NewProp_Scenes = { "Scenes", nullptr, (EPropertyFlags)0x0010008008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(_Script_UE_Assimp_eventOnImportSceneComplete_Parms, Scenes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Scenes_MetaData), NewProp_Scenes_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_UE_Assimp_OnImportSceneComplete__DelegateSignature_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_UE_Assimp_OnImportSceneComplete__DelegateSignature_Statics::NewProp_Scenes_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_UE_Assimp_OnImportSceneComplete__DelegateSignature_Statics::NewProp_Scenes,
};
...
void FOnImportSceneComplete_DelegateWrapper(const FScriptDelegate& OnImportSceneComplete, TArray<UAIScene*> const& Scenes)
{
	struct _Script_UE_Assimp_eventOnImportSceneComplete_Parms
	{
		TArray<UAIScene*> Scenes;
...
// Begin Class UAssimpImportContext
void UAssimpImportContext::StaticRegisterNativesUAssimpImportContext()
{
}
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UAssimpImportContext);
UClass* Z_Construct_UClass_UAssimpImportContext_NoRegister()
{
	return UAssimpImportContext::StaticClass();
}
struct Z_Construct_UClass_UAssimpImportContext_Statics
{
#if WITH_METADATA
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ResultScenes_MetaData[] = {
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/AssimpFunctionLibrary.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_FailedFiles_MetaData[] = {
		{ "ModuleRelativePath", "Public/AssimpFunctionLibrary.h" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FObjectPropertyParams NewProp_ResultScenes_Inner;
	static const UECodeGen_Private::FArrayPropertyParams NewProp_ResultScenes;
	static const UECodeGen_Private::FStrPropertyParams NewProp_FailedFiles_Inner;
	static const UECodeGen_Private::FArrayPropertyParams NewProp_FailedFiles;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static UObject* (*const DependentSingletons[])();
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
		TCppClassTypeTraits<UAssimpImportContext>::IsAbstract,
	};
	static const UECodeGen_Private::FClassParams ClassParams;
};
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UAssimpImportContext_Statics::NewProp_ResultScenes_Inner = { "ResultScenes", nullptr, (EPropertyFlags)0x0104000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UAIScene_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAssimpImportContext_Statics::NewProp_ResultScenes = { "ResultScenes", nullptr, (EPropertyFlags)0x0114008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAssimpImportContext, ResultScenes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ResultScenes_MetaData), NewProp_ResultScenes_MetaData) };
const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UAssimpImportContext_Statics::NewProp_FailedFiles_Inner = { "FailedFiles", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAssimpImportContext_Statics::NewProp_FailedFiles = { "FailedFiles", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAssimpImportContext, FailedFiles), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FailedFiles_MetaData), NewProp_FailedFiles_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAssimpImportContext_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAssimpImportContext_Statics::NewProp_ResultScenes_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAssimpImportContext_Statics::NewProp_ResultScenes,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAssimpImportContext_Statics::NewProp_FailedFiles_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAssimpImportContext_Statics::NewProp_FailedFiles,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssimpImportContext_Statics::PropPointers) < 2048);
UObject* (*const Z_Construct_UClass_UAssimpImportContext_Statics::DependentSingletons[])() = {
	(UObject* (*)())Z_Construct_UClass_UObject,
	(UObject* (*)())Z_Construct_UPackage__Script_UE_Assimp,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UAssimpImportContext_Statics::DependentSingletons) < 16);
const UECodeGen_Private::FClassParams Z_Construct_UClass_UAssimpImportContext_Statics::ClassParams = {
	&UAssimpImportContext::StaticClass,
	nullptr,
	&StaticCppClassTypeInfo,
	DependentSingletons,
	nullptr,
	Z_Construct_UClass_UAssimpImportContext_Statics::PropPointers,
	nullptr,
	UE_ARRAY_COUNT(DependentSingletons),
	0,
	UE_ARRAY_COUNT(Z_Construct_UClass_UAssimpImportContext_Statics::PropPointers),
	0,
	0x009000A0u,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UAssimpImportContext_Statics::Class_MetaDataParams), Z_Construct_UClass_UAssimpImportContext_Statics::Class_MetaDataParams)
};
UClass* Z_Construct_UClass_UAssimpImportContext()
{
	if (!Z_Registration_Info_UClass_UAssimpImportContext.OuterSingleton)
	{
		UECodeGen_Private::ConstructUClass(Z_Registration_Info_UClass_UAssimpImportContext.OuterSingleton, Z_Construct_UClass_UAssimpImportContext_Statics::ClassParams);
	}
	return Z_Registration_Info_UClass_UAssimpImportContext.OuterSingleton;
}
template<> UE_ASSIMP_API UClass* StaticClass<UAssimpImportContext>()
{
	return UAssimpImportContext::StaticClass();
}
UAssimpImportContext::UAssimpImportContext(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
DEFINE_VTABLE_PTR_HELPER_CTOR(UAssimpImportContext);
UAssimpImportContext::~UAssimpImportContext() {}
// End Class UAssimpImportContext
...
// Begin Class UAssimpFunctionLibrary Function CancelImport
struct Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport_Statics
{
	struct AssimpFunctionLibrary_eventCancelImport_Parms
	{
		UAssimpImportContext* Context;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Assimp" },
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport_Statics::NewProp_Context = { "Context", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventCancelImport_Parms, Context), Z_Construct_UClass_UAssimpImportContext_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport_Statics::NewProp_Context,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAssimpFunctionLibrary, nullptr, "CancelImport", nullptr, nullptr, Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport_Statics::AssimpFunctionLibrary_eventCancelImport_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport_Statics::AssimpFunctionLibrary_eventCancelImport_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UAssimpFunctionLibrary::execCancelImport)
{
	P_GET_OBJECT(UAssimpImportContext,Z_Param_Context);
	P_FINISH;
	P_NATIVE_BEGIN;
	UAssimpFunctionLibrary::CancelImport(Z_Param_Context);
	P_NATIVE_END;
}
// End Class UAssimpFunctionLibrary Function CancelImport

// Begin Class UAssimpFunctionLibrary Function CreateScences
struct Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics
{
	struct AssimpFunctionLibrary_eventCreateScences_Parms
	{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AIScenes_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FObjectPropertyParams NewProp_WorldContextObject;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_AIScenes_Inner;
	static const UECodeGen_Private::FArrayPropertyParams NewProp_AIScenes;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_Parent;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventCreateScences_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::NewProp_AIScenes_Inner = { "AIScenes", nullptr, (EPropertyFlags)0x0000000000080000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UAIScene_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::NewProp_AIScenes = { "AIScenes", nullptr, (EPropertyFlags)0x0010008000000080, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventCreateScences_Parms, AIScenes), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AIScenes_MetaData), NewProp_AIScenes_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::NewProp_Parent = { "Parent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventCreateScences_Parms, Parent), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::NewProp_WorldContextObject,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::NewProp_AIScenes_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::NewProp_AIScenes,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::NewProp_Parent,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAssimpFunctionLibrary, nullptr, "CreateScences", nullptr, nullptr, Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::AssimpFunctionLibrary_eventCreateScences_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::AssimpFunctionLibrary_eventCreateScences_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UAssimpFunctionLibrary::execCreateScences)
{
	P_GET_OBJECT(UObject,Z_Param_WorldContextObject);
	P_GET_TARRAY(UAIScene*,Z_Param_AIScenes);
	P_GET_OBJECT(UMaterialInterface,Z_Param_Parent);
	P_FINISH;
	P_NATIVE_BEGIN;
	UAssimpFunctionLibrary::CreateScences(Z_Param_WorldContextObject,Z_Param_AIScenes,Z_Param_Parent);
	P_NATIVE_END;
}
// End Class UAssimpFunctionLibrary Function CreateScences
...
// Begin Class UAssimpFunctionLibrary Function GetTexturePath
struct Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics
{
	struct AssimpFunctionLibrary_eventGetTexturePath_Parms
	{
		const UAIScene* Scene;
		const UAIMaterial* Material;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::NewProp_Scene = { "Scene", nullptr, (EPropertyFlags)0x0010000000080082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventGetTexturePath_Parms, Scene), Z_Construct_UClass_UAIScene_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Scene_MetaData), NewProp_Scene_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::NewProp_Material = { "Material", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventGetTexturePath_Parms, Material), Z_Construct_UClass_UAIMaterial_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Material_MetaData), NewProp_Material_MetaData) };
const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::NewProp_TextureType = { "TextureType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventGetTexturePath_Parms, TextureType), Z_Construct_UEnum_UE_Assimp_EAiTextureType, METADATA_PARAMS(0, nullptr) }; // 2376152309
const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventGetTexturePath_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::NewProp_Scene,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::NewProp_Material,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::NewProp_TextureType,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAssimpFunctionLibrary, nullptr, "GetTexturePath", nullptr, nullptr, Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::AssimpFunctionLibrary_eventGetTexturePath_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::AssimpFunctionLibrary_eventGetTexturePath_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UAssimpFunctionLibrary::execGetTexturePath)
{
	P_GET_OBJECT(UAIScene,Z_Param_Scene);
	P_GET_OBJECT(UAIMaterial,Z_Param_Material);
	P_GET_PROPERTY(FByteProperty,Z_Param_TextureType);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(FString*)Z_Param__Result=UAssimpFunctionLibrary::GetTexturePath(Z_Param_Scene,Z_Param_Material,EAiTextureType(Z_Param_TextureType));
	P_NATIVE_END;
}
// End Class UAssimpFunctionLibrary Function GetTexturePath

// Begin Class UAssimpFunctionLibrary Function HasTexture
struct Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics
{
	struct AssimpFunctionLibrary_eventHasTexture_Parms
	{
		const UAIScene* Scene;
		const UAIMaterial* Material;
		TEnumAsByte<EAiTextureType> TextureType;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::NewProp_Scene = { "Scene", nullptr, (EPropertyFlags)0x0010000000080082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventHasTexture_Parms, Scene), Z_Construct_UClass_UAIScene_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Scene_MetaData), NewProp_Scene_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::NewProp_Material = { "Material", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventHasTexture_Parms, Material), Z_Construct_UClass_UAIMaterial_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Material_MetaData), NewProp_Material_MetaData) };
const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::NewProp_TextureType = { "TextureType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventHasTexture_Parms, TextureType), Z_Construct_UEnum_UE_Assimp_EAiTextureType, METADATA_PARAMS(0, nullptr) }; // 2376152309
void Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((AssimpFunctionLibrary_eventHasTexture_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AssimpFunctionLibrary_eventHasTexture_Parms), &Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::NewProp_Scene,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::NewProp_Material,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::NewProp_TextureType,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAssimpFunctionLibrary, nullptr, "HasTexture", nullptr, nullptr, Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::AssimpFunctionLibrary_eventHasTexture_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::AssimpFunctionLibrary_eventHasTexture_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UAssimpFunctionLibrary::execHasTexture)
{
	P_GET_OBJECT(UAIScene,Z_Param_Scene);
	P_GET_OBJECT(UAIMaterial,Z_Param_Material);
	P_GET_PROPERTY(FByteProperty,Z_Param_TextureType);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=UAssimpFunctionLibrary::HasTexture(Z_Param_Scene,Z_Param_Material,EAiTextureType(Z_Param_TextureType));
	P_NATIVE_END;
}
// End Class UAssimpFunctionLibrary Function HasTexture
...
struct Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics
{
	...
	static const UECodeGen_Private::FIntPropertyParams NewProp_MaxMeshesVal;
	static const UECodeGen_Private::FIntPropertyParams NewProp_MaxCamerasVal;
	static const UECodeGen_Private::FIntPropertyParams NewProp_MaxLightsVal;
	static const UECodeGen_Private::FIntPropertyParams NewProp_MaxMaterialsVal;
	static const UECodeGen_Private::FIntPropertyParams NewProp_MaxNodesVal;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_HandleTime;
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_InFilenames = { "InFilenames", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportScenesAsync_Parms, InFilenames), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InFilenames_MetaData), NewProp_InFilenames_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportScenesAsync_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(0, nullptr) };
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_MaxConcurrentTasks = { "MaxConcurrentTasks", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportScenesAsync_Parms, MaxConcurrentTasks), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_MaxMeshesVal = { "MaxMeshesVal", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportScenesAsync_Parms, MaxMeshesVal), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_MaxCamerasVal = { "MaxCamerasVal", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportScenesAsync_Parms, MaxCamerasVal), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_MaxLightsVal = { "MaxLightsVal", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportScenesAsync_Parms, MaxLightsVal), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_MaxMaterialsVal = { "MaxMaterialsVal", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportScenesAsync_Parms, MaxMaterialsVal), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_MaxNodesVal = { "MaxNodesVal", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportScenesAsync_Parms, MaxNodesVal), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_HandleTime = { "HandleTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportScenesAsync_Parms, HandleTime), METADATA_PARAMS(0, nullptr) };
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportScenesAsync_Parms, ReturnValue), Z_Construct_UClass_UAssimpImportContext_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_WorldContextObject,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_MaxConcurrentTasks,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_MaxMeshesVal,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_MaxCamerasVal,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_MaxLightsVal,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_MaxMaterialsVal,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_MaxNodesVal,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync_Statics::NewProp_HandleTime,
...
DEFINE_FUNCTION(UAssimpFunctionLibrary::execImportScenesAsync)
{
	...
	P_GET_PROPERTY(FIntProperty,Z_Param_MaxMeshesVal);
	P_GET_PROPERTY(FIntProperty,Z_Param_MaxCamerasVal);
	P_GET_PROPERTY(FIntProperty,Z_Param_MaxLightsVal);
	P_GET_PROPERTY(FIntProperty,Z_Param_MaxMaterialsVal);
	P_GET_PROPERTY(FIntProperty,Z_Param_MaxNodesVal);
	P_GET_PROPERTY(FFloatProperty,Z_Param_HandleTime);
	P_GET_PROPERTY(FDelegateProperty,Z_Param_OnProgressUpdated);
	P_GET_PROPERTY(FDelegateProperty,Z_Param_OnImportSceneComplete);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(UAssimpImportContext**)Z_Param__Result=UAssimpFunctionLibrary::ImportScenesAsync(Z_Param_Out_InFilenames,Z_Param_WorldContextObject,Z_Param_Flags,Z_Param_DisableAutoSpaceChange,Z_Param_MaxConcurrentTasks,Z_Param_MaxMeshesVal,Z_Param_MaxCamerasVal,Z_Param_MaxLightsVal,Z_Param_MaxMaterialsVal,Z_Param_MaxNodesVal,Z_Param_HandleTime,FOnProgressUpdated(Z_Param_OnProgressUpdated),FOnImportSceneComplete(Z_Param_OnImportSceneComplete));
	P_NATIVE_END;
}
// End Class UAssimpFunctionLibrary Function ImportScenesAsync

// Begin Class UAssimpFunctionLibrary Function ImportTextureAsync
struct Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics
{
	struct AssimpFunctionLibrary_eventImportTextureAsync_Parms
	{
		UObject* WorldContextObject;
		TEnumAsByte<EAiTextureType> TextureType;
		FName DynamicMaterialParamName;
		UAIScene* AssimpScene;
		UAIMaterial* AssimpMaterial;
		UMaterialInstanceDynamic* DynamicMaterialUnreal;
		bool ReturnValue;
	};
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "Category", "Texture Import" },
		{ "CPP_Default_AssimpMaterial", "None" },
		{ "CPP_Default_AssimpScene", "None" },
		{ "CPP_Default_DynamicMaterialParamName", "" },
		{ "CPP_Default_DynamicMaterialUnreal", "None" },
		{ "CPP_Default_TextureType", "AiTextureType_NONE" },
		{ "ModuleRelativePath", "Public/AssimpFunctionLibrary.h" },
		{ "WorldContext", "WorldContextObject" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AssimpScene_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FObjectPropertyParams NewProp_WorldContextObject;
	static const UECodeGen_Private::FBytePropertyParams NewProp_TextureType;
	static const UECodeGen_Private::FNamePropertyParams NewProp_DynamicMaterialParamName;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_AssimpScene;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_AssimpMaterial;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_DynamicMaterialUnreal;
	static void NewProp_ReturnValue_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
	static const UECodeGen_Private::FFunctionParams FuncParams;
};
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportTextureAsync_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_TextureType = { "TextureType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportTextureAsync_Parms, TextureType), Z_Construct_UEnum_UE_Assimp_EAiTextureType, METADATA_PARAMS(0, nullptr) }; // 2376152309
const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_DynamicMaterialParamName = { "DynamicMaterialParamName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportTextureAsync_Parms, DynamicMaterialParamName), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_AssimpScene = { "AssimpScene", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportTextureAsync_Parms, AssimpScene), Z_Construct_UClass_UAIScene_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AssimpScene_MetaData), NewProp_AssimpScene_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_AssimpMaterial = { "AssimpMaterial", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportTextureAsync_Parms, AssimpMaterial), Z_Construct_UClass_UAIMaterial_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_DynamicMaterialUnreal = { "DynamicMaterialUnreal", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventImportTextureAsync_Parms, DynamicMaterialUnreal), Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((AssimpFunctionLibrary_eventImportTextureAsync_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AssimpFunctionLibrary_eventImportTextureAsync_Parms), &Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_WorldContextObject,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_TextureType,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_DynamicMaterialParamName,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_AssimpScene,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_AssimpMaterial,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_DynamicMaterialUnreal,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAssimpFunctionLibrary, nullptr, "ImportTextureAsync", nullptr, nullptr, Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::AssimpFunctionLibrary_eventImportTextureAsync_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::AssimpFunctionLibrary_eventImportTextureAsync_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UAssimpFunctionLibrary::execImportTextureAsync)
{
	P_GET_OBJECT(UObject,Z_Param_WorldContextObject);
	P_GET_PROPERTY(FByteProperty,Z_Param_TextureType);
	P_GET_PROPERTY(FNameProperty,Z_Param_DynamicMaterialParamName);
	P_GET_OBJECT(UAIScene,Z_Param_AssimpScene);
	P_GET_OBJECT(UAIMaterial,Z_Param_AssimpMaterial);
	P_GET_OBJECT(UMaterialInstanceDynamic,Z_Param_DynamicMaterialUnreal);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=UAssimpFunctionLibrary::ImportTextureAsync(Z_Param_WorldContextObject,EAiTextureType(Z_Param_TextureType),Z_Param_DynamicMaterialParamName,Z_Param_AssimpScene,Z_Param_AssimpMaterial,Z_Param_DynamicMaterialUnreal);
	P_NATIVE_END;
}
// End Class UAssimpFunctionLibrary Function ImportTextureAsync
...
// Begin Class UAssimpFunctionLibrary Function ProcessNodes
struct Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics
{
	struct AssimpFunctionLibrary_eventProcessNodes_Parms
	{
		UObject* WorldContextObject;
		UAINode* RootNode;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventProcessNodes_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::NewProp_RootNode = { "RootNode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventProcessNodes_Parms, RootNode), Z_Construct_UClass_UAINode_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::NewProp_Materials_Inner = { "Materials", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UMaterialInstanceDynamic_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::NewProp_Materials = { "Materials", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AssimpFunctionLibrary_eventProcessNodes_Parms, Materials), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Materials_MetaData), NewProp_Materials_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::NewProp_WorldContextObject,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::NewProp_RootNode,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::NewProp_Materials_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::NewProp_Materials,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAssimpFunctionLibrary, nullptr, "ProcessNodes", nullptr, nullptr, Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::PropPointers), sizeof(Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::AssimpFunctionLibrary_eventProcessNodes_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04422401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::Function_MetaDataParams), Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::AssimpFunctionLibrary_eventProcessNodes_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UAssimpFunctionLibrary::execProcessNodes)
{
	P_GET_OBJECT(UObject,Z_Param_WorldContextObject);
	P_GET_OBJECT(UAINode,Z_Param_RootNode);
	P_GET_TARRAY_REF(UMaterialInstanceDynamic*,Z_Param_Out_Materials);
	P_FINISH;
	P_NATIVE_BEGIN;
	UAssimpFunctionLibrary::ProcessNodes(Z_Param_WorldContextObject,Z_Param_RootNode,Z_Param_Out_Materials);
	P_NATIVE_END;
}
// End Class UAssimpFunctionLibrary Function ProcessNodes
...
void UAssimpFunctionLibrary::StaticRegisterNativesUAssimpFunctionLibrary()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "CancelImport", &UAssimpFunctionLibrary::execCancelImport },
		{ "CreateScences", &UAssimpFunctionLibrary::execCreateScences },
		...
		{ "GetTexturePath", &UAssimpFunctionLibrary::execGetTexturePath },
		{ "HasTexture", &UAssimpFunctionLibrary::execHasTexture },
		...
		{ "ImportTextureAsync", &UAssimpFunctionLibrary::execImportTextureAsync },
		...
		{ "ProcessNodes", &UAssimpFunctionLibrary::execProcessNodes },
...
struct Z_Construct_UClass_UAssimpFunctionLibrary_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UAssimpFunctionLibrary_CancelImport, "CancelImport" }, // 6272089
		{ &Z_Construct_UFunction_UAssimpFunctionLibrary_CreateScences, "CreateScences" }, // 3824253654
		...
		{ &Z_Construct_UFunction_UAssimpFunctionLibrary_GetTexturePath, "GetTexturePath" }, // 1179321542
		{ &Z_Construct_UFunction_UAssimpFunctionLibrary_HasTexture, "HasTexture" }, // 3739758117
		...
		{ &Z_Construct_UFunction_UAssimpFunctionLibrary_ImportScenesAsync, "ImportScenesAsync" }, // 2113988652
		{ &Z_Construct_UFunction_UAssimpFunctionLibrary_ImportTextureAsync, "ImportTextureAsync" }, // 734176755
		...
		{ &Z_Construct_UFunction_UAssimpFunctionLibrary_ProcessNodes, "ProcessNodes" }, // 4174077829
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AssimpFunctionLibrary_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAssimpImportContext, UAssimpImportContext::StaticClass, TEXT("UAssimpImportContext"), &Z_Registration_Info_UClass_UAssimpImportContext, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssimpImportContext), 1661199716U) },
		{ Z_Construct_UClass_UAssimpFunctionLibrary, UAssimpFunctionLibrary::StaticClass, TEXT("UAssimpFunctionLibrary"), &Z_Registration_Info_UClass_UAssimpFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssimpFunctionLibrary), 4254662186U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AssimpFunctionLibrary_h_2449480244(TEXT("/Script/UE_Assimp"),
	Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AssimpFunctionLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Test_AssimpHolder_AssimpHolder_Plugins_UE4_Assimp_Source_UE_Assimp_Public_AssimpFunctionLibrary_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
